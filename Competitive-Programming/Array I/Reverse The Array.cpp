...
Considering e-based indexing we have M = 3 so the subarray[M+1 -N-1] has to be reversed.
Therefore the required output will be (1, 2, 3, 4, 6 , 5}.

For the second test case,
Considering 0-based indexing we have H 2 so thesubarray[H+1 N-1] has to be reversed.
